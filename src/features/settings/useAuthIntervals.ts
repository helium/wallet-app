...
export default () => {
  ...
  return [
    {
      label: t('settings.sections.security.authIntervals.immediately'),
      value: Intervals.IMMEDIATELY,
    },
    {
      label: t('settings.sections.security.authIntervals.after_1_min'),
      value: Intervals.ONE_MIN,
    },
    {
      label: t('settings.sections.security.authIntervals.after_5_min'),
      value: Intervals.FIVE_MIN,
    },
    {
      label: t('settings.sections.security.authIntervals.after_15_min'),
      value: Intervals.FIFTEEN_MIN,
    },
    {
      label: t('settings.sections.security.authIntervals.after_1_hr'),
      value: Intervals.ONE_HOUR,
    },
    {
      label: t('settings.sections.security.authIntervals.after_4_hr'),
