export default {
  ...
  accountsScreen: {
    ...
    solWarning:
      'Your balance may not have enough SOL to cover all transactions. Solana wallets require a minimum of 0.00089088 SOL. We recommend keeping > 0.02 sol in your wallet for the best experience',
