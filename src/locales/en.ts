export default {
  ...
  gov: {
    ...
    assignProxy: {
      ...
      searchPlaceholder: 'Search Proxies or Paste Wallet Address',
  ...
  deprecatedTokensModal: {
    title: 'Important: Token Deprecation Notice',
    body: 'IOT and MOBILE tokens have been deprecated as of January 2025. You can swap them to HNT, the primary token powering Helium. If you have staked positions, they will be unstaked first.',
    unstaked: 'Unstaked: {{amount}}',
    staked: 'Staked: {{amount}}',
    swapNow: 'Swap to HNT',
    unstakeAndSwap: 'Unstake & Swap to HNT',
    remindLater: 'Remind Me Later',
    dismiss: "I Understand, Don't Show Again",
    loadingPositions: 'Loading your positions...',
    processing: 'Processing...',
    unstaking: 'Closing Positions',
    closingPositions: 'Closing the following staked positions:',
